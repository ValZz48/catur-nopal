            ...
            <div className="md:col-span-8 bg-[#312e2b] rounded-3xl p-6 border border-[#3c3934] shadow-md">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 bg-[#2d2a27] p-1.5 rounded-2xl border border-[#3c3934]">
                  {[
                    { id: 'martin', elo: 250, name: 'Martin', avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=Martin', tip: 'Menguasai lajur tengah papan catur dengan pion di fase awal pembukaan akan memberikan ruang gerak luas bagi perwira utamamu. Selalu pastikan Raja Anda terlindungi melalui rokade cepat sebelum menginisiasi serangan!' },
                    { id: 'nelson', elo: 1300, name: 'Nelson', avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=Nelson', tip: 'Jangan panik jika lawan menyerang dengan Ratu terlalu awal. Amankan koordinat f7 dan f2 dengan baik, kemudian kembangkan perwira kecilmu untuk mengejar Ratu yang terlalu aktif.' },
                    { id: 'wally', elo: 1800, name: 'Wally', avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=Wally', tip: 'Struktur pion kokoh adalah kunci sukses posisi taktis catur solid. Jaga keutuhan barisan pionmu, lakukan manuver perlahan untuk mendominasi jalur-terbuka dengan Benteng.' },
                    { id: 'magnus', elo: 2850, name: 'Magnus', avatar: 'https://api.dicebear.com/7.x/avataaars/png?seed=Magnus', tip: 'Setiap langkah harus dijalankan dengan presisi kalkulatif tingkat tinggi. Di fase permainan akhir (endgame), aktifkan Rajamu ke baris tengah untuk menyokong penetrasi pion promosi.' }
                  ].map((coach) => {
