export type GameMode = 'menu' | 'select-character' | 'play' | 'puzzles' | 'lessons' | 'store' | 'online-match' | 'analysis' | 'local-friend' | 'home' | 'settings' | 'profile' | 'season-pass' | 'rank' | 'tournament' | 'guild-suku' | 'forum-diskusi' | 'toko-deals' | 'statistik-elo' | 'koleksi-pokedex' | 'season-events' | 'features-61to70';
